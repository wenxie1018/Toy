...
<head>
    ...
    <title>玩物喪薪|BANPRESTO 景品 QPOSKET 美少女戰士Eternal 木野真琴</title>
...
<body id="body1">
    ...
    <section style="height: 900px;">
        ...
        <div class="slideshow-container">
            ...
            <div class="mySlides fade">
              <img src="assets/美少女戰士/2/8.jpg" style="width:100%">
            </div>
          ...
          <div class="productname">
            <h1>BANPRESTO 景品 QPOSKET 美少女戰士Eternal 木野真琴</h1><br>
            ...
            <ul class="btn-numbox">
                ...
                <li><span class="kucun">（庫存:51）</span></li>
    　　　  </ul>
    ...
    <div class="com">
      ...
      <img src="assets/美少女戰士/2/2.jpg" class="merimg"><p>
      <img src="assets/美少女戰士/2/8.jpg" class="merimg" style="margin-bottom: 30px;">
      </div>
      <div class="link-top"></div>
      ...
      <div class="comment">
        ...
        <div class="comment">
          <div class="avatar11">
            ...
            <div class="cname"><name>小黑</name> <date>2021-12-29</date></div> 
            <div class="star">
              <img src="assets/star.png" class="starimg">
              <img src="assets/star.png" class="starimg">
              <img src="assets/star.png" class="starimg">
          ...
          <div class="comment">
            <div class="avatar11">
              ...
              <div class="cname"><name>阿橘</name> <date>2021-12-31</date></div> 
              <div class="star">
                <img src="assets/star.png" class="starimg">
                <img src="assets/star.png" class="starimg">
                <img src="assets/star.png" class="starimg">
            ...
            <div class="comment">
              <div class="avatar11">
                ...
                <div class="cname"><name>小可愛</name> <date>2022-01-05</date></div> 
                <div class="star">
                  <img src="assets/star.png" class="starimg">
                  <img src="assets/star.png" class="starimg">
                  <img src="assets/star.png" class="starimg">
