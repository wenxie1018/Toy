...
<head>
    ...
    <title>玩物喪薪|BANDAI Super Sailor Moon 美少女戰士月野兔</title>
...
<body id="body1">
    <header id="navbar">
		  ...
		  <%}%>
          <h2 style="margin-left:80px ; margin-top: 5px;"><a style="color: black; text-decoration: none;" href="index.html">玩物喪薪</a></h2>
    </header>
    ...
    <section style="height: 900px;">
        ...
        <div class="slideshow-container">
            ...
            <div class="mySlides fade">
              <img src="assets/美少女戰士/月野兔/girl.jpg" style="width:100%">
            </div>
          ...
          <div class="productname">
            <h1>BANDAI Super Sailor Moon 美少女戰士月野兔</h1><br>
            <p class="money">NT$3,580</p><br>
            <ul class="btn-numbox">
                ...
                <li><span class="kucun">（庫存:33）</span></li>
    　　　  </ul>
    ...
    <div class="com">
      ...
      <img src="assets/美少女戰士/月野兔/girl.jpg" class="merimg"><P>
      <img src="assets/美少女戰士/月野兔/2.jpg" class="merimg"><p>
      <img src="assets/美少女戰士/月野兔/3.jpg" class="merimg" style="margin-bottom: 30px;">
      </div>
      <div class="link-top"></div>
      ...
      <div class="link-top"></div>
      <div style="text-align: left; font-size: 20px; color: rgb(104, 103, 103); margin-left: 10px;">55則評論</div>
      <div class="comment">
        <div class="avatar11">
          <img src="assets/astronaut.png" class="avatar">
        </div>
          <div class="cname"><name>阿恆</name> <date>2021-12-27</date></div> 
          <div class="star">
        ...
        <div class="comment">
          <div class="avatar11">
            ...
            <div class="cname"><name>小小兵</name> <date>2021-12-29</date></div> 
            <div class="star">
              <img src="assets/star.png" class="starimg">
              <img src="assets/star.png" class="starimg">
              <img src="assets/star.png" class="starimg">
            ...
            <div class="c">
              <c>評論：</c>包裝有些凹陷，不過內部防護措施完善，商品完整，希望下次能注意~
            </div>
          </div>
          <div class="link-top"></div>
          <div class="comment">
            <div class="avatar11">
              ...
              <div class="cname"><name>羊咩</name> <date>2021-12-31</date></div> 
              <div class="star">
                <img src="assets/star.png" class="starimg">
                <img src="assets/star.png" class="starimg">
                <img src="assets/star.png" class="starimg">
            ...
            <div class="comment">
              <div class="avatar11">
                ...
                <div class="cname"><name>小阿呆</name> <date>2022-01-05</date></div> 
                <div class="star">
                  <img src="assets/star.png" class="starimg">
                  <img src="assets/star.png" class="starimg">
                  <img src="assets/star.png" class="starimg">
