...
<head>
    ...
    <title>玩物喪薪|Medicom Toy UDF 蠟筆小新3 露屁屁怪獸</title>
...
<body id="body1">
    <header id="navbar">
            ...
            <div class="dropdown">
              <a href="shoppingcart.jsp"></a><button class="dropbtn" style="color: black;">購物車</button></a>
    ...
    <section style="height: 900px;">
        ...
        <div class="slideshow-container">
            ...
            <div class="mySlides fade">
              <img src="assets/蠟筆小新/露屁屁怪獸/1.jpg" style="width:100%">
            </div>
            <div class="mySlides fade">
              <img src="assets/蠟筆小新/露屁屁怪獸/2.jpg" style="width:100%">
            </div>
            <div class="mySlides fade">
              <img src="assets/蠟筆小新/露屁屁怪獸/3.jpg" style="width:100%">
            </div>
          ...
          <div class="productname">
            <h1>Medicom Toy UDF 蠟筆小新3 露屁屁怪獸</h1><br>
            ...
            <ul class="btn-numbox">
                ...
                <li><span class="kucun">（庫存:40）</span></li>
    　　　  </ul>
    ...
    <div class="com">
      ...
      <img src="assets/蠟筆小新/露屁屁怪獸/1.jpg" class="merimg"><p>
      <img src="assets/蠟筆小新/露屁屁怪獸/2.jpg" class="merimg"><p>
      <img src="assets/蠟筆小新/露屁屁怪獸/3.jpg" class="merimg" style="margin-bottom: 30px;">
      </div>
      <div class="link-top"></div>
