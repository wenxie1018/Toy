...
<body id="body1">
    ...
    <section>
        <a href="index.jsp"><img class="producttit"src="assets/logo4.png" width="400px"></a>
		  ...
		  String sql1="SELECT`img`,`productname`,`productname2`,`smalltit`,`location` FROM `product`";
		  ...
		  while(rs1.next()){
				  ...
				  if(i%3==1){
					  ...
					  out.println("<div class='product-container2'>");
...
<!--		  
	      <div class="product-container2">
            <a href="merchandise1-1.jsp" class="prd">
              <img src="" width="300px">
              <p class="productname"><br></p>
              <p class="smalltit"></p>
          ...
          <div class="product-container2">
            <a href="merchandise1-2.jsp" class="prd">
            <img src="" width="300px">
              <p class="productname"><br></p>
              <p class="smalltit"></p>
              <button class="buttoncart"><img src="assets/trolley-cart.png" width="30px"></button>
          ...
          <div class="product-container2">
            <a href="merchandise1-3.jsp" class="prd">
            <img src="" width="300px">
              <p class="productname"><br></p>
              <p class="smalltit"></p>
              <button class="buttoncart"><img src="assets/trolley-cart.png" width="30px"></button>
        ...
        <div class="product1"> 
          <div class="product-container2">
            <a href="merchandise1-4.jsp" class="prd">
            <img src="" width="300px">
              <p class="productname"><br></p>
              <p class="smalltit"></p>
              <button class="buttoncart"><img src="assets/trolley-cart.png" width="30px"></button>
            ...
            <div class="product-container2">
              <a href="merchandise2-1.jsp" class="prd">
                <img src="" width="300px">
                <p class="productname"> <br></p>
                <p class="smalltit"></p>
                <button class="buttoncart"><img src="assets/trolley-cart.png" width="30px"></button>
            ...
            <div class="product-container2">
              <a href="merchandise2-2.jsp" class="prd">
                <img src="" width="300px">
                <p class="productname"><br></p>
                <p class="smalltit"></p>
                <button class="buttoncart"><img src="assets/trolley-cart.png" width="30px"></button>
        ...
        <div class="product1"> 
          <div class="product-container2">
            <a href="merchandise2-3.jsp" class="prd">
              <img src="" width="300px">
              <p class="productname"><br></p>
              <p class="smalltit"></p>
              <button class="buttoncart"><img src="assets/trolley-cart.png" width="30px"></button>
            ...
            <div class="product-container2">
              <a href="merchandise2-4.jsp" class="prd">
                <img src="" width="300px">
                <p class="productname"><br></p>
                <p class="smalltit"></p>
                <button class="buttoncart"><img src="assets/trolley-cart.png" width="30px"></button>
            ...
            <div class="product-container2">
              <a href="merchandise2-5.jsp" class="prd">
                <img src="" width="300px">
                <p class="productname"><br></p>
                <p class="smalltit"></p>
                <button class="buttoncart"><img src="assets/trolley-cart.png" width="30px"></button>
		...
		<div class="product1">
			<div class="product-container2">
			  <a href="merchandise2-6.jsp" class="prd">
				<img src="" width="300px">
				<p class="productname"><br>></p>
				<p class="smalltit"></p>
				<button class="buttoncart"><img src="assets/trolley-cart.png" width="30px"></button>
			...
			<div class="product-container2">
			  <a href="merchandise3-1.jsp" class="prd">
			  <img src="" width="300px">
			  <p class="productname">  <br> </p>
			  <p class="smalltit"></p>
			  <button class="buttoncart"><img src="assets/trolley-cart.png" width="30px"></button>
		  ...
		  <div class="product-container2">
			<a href="merchandise3-2.jsp" class="prd">
			  <img src="" width="300px">
			  <p class="productname"><br></p>
			  <p class="smalltit"></p><br>
			  <button class="buttoncart"><img src="assets/trolley-cart.png" width="30px"></button>
			  <button class="buttonfavorite"><img src="assets/favorite.png" width="30px"></button>
			</a>
		  </div>
		...
		<div class="product1">
		  <div class="product-container2">
			<a href="merchandise3-3.jsp" class="prd">
			<img src="" width="300px">
			<p class="productname"><br></p>
			<p class="smalltit"></p>
			<button class="buttoncart"><img src="assets/trolley-cart.png" width="30px"></button>
		  ...
		  <div class="product-container2">
			<a href="merchandise3-4.jsp" class="prd">
			<img src="" width="300px">
			<p class="productname"> <br></p>
			<p class="smalltit"></p>
			<button class="buttoncart"><img src="assets/trolley-cart.png" width="30px"></button>
		...
		<div class="product-container2">
		  <a href="merchandise3-5.jsp" class="prd">
			<img src="" width="300px">
			<p class="productname"><br></p>
			<p class="smalltit"></p>
			<button class="buttoncart"><img src="assets/trolley-cart.png" width="30px"></button>
	  ...
	  <div class="product1">
		<div class="product-container2">
		  <a href="merchandise4-1.jsp" class="prd">
		  <img src="" width="200px">
		  <p class="productname"><br></p>
		  <p class="smalltit"></p>
		  <button class="buttoncart"><img src="assets/trolley-cart.png" width="30px"></button>
		...
		<div class="product-container2">
		  <a href="merchandise4-2.jsp" class="prd">
		  <img src="" width="300px">
		  <p class="productname"><br></p>
		  <p class="smalltit"></p>
		  <button class="buttoncart"><img src="assets/trolley-cart.png" width="30px"></button>
		...
		<div class="product-container2">
		  <a href="merchandise4-3.jsp" class="prd">
		  <img src="" width="300px">
		  <p class="productname"><br></p>
		  <p class="smalltit"></p>
		  <button class="buttoncart"><img src="assets/trolley-cart.png" width="30px"></button>
