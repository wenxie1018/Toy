...
<head>
    ...
    <title>玩物喪薪|LOOK UP 抬頭系列 Q版造型公仔 竈門炭治郎</title>
...
<body id="body1">
    ...
    <section style="height: 900px;">
        ...
        <div class="slideshow-container">
            ...
            <div class="mySlides fade">
              <img src="assets/鬼滅抬頭/0/0.png" style="width:100%">
            </div>
          
            <div class="mySlides fade">
              <img src="assets/鬼滅抬頭/0/0-1.png" style="width:100%">
            </div>
          ...
          <div class="productname">
            <h1>LOOK UP 抬頭系列 Q版造型公仔 竈門炭治郎</h1><br>
    ...
    <div class="com">
      ...
      <img src="assets/鬼滅抬頭/0/0.jpg" class="merimg"><P>
      <img src="assets/鬼滅抬頭/0/0-1.jfif" class="merimg"><p>
      <img src="assets/鬼滅抬頭/0/0-2.jpg" class="merimg"><p>
      <img src="assets/鬼滅抬頭/0/0-3.jpg" class="merimg" style="margin-bottom: 30px;">
      </div>
      <div class="link-top"></div>
      ...
      <div class="comment">
        <div class="avatar11">
          ...
          <div class="cname"><name>小可愛</name> <date>2021-12-27</date></div> 
          <div class="star">
        ...
        <div class="comment">
          <div class="avatar11">
            ...
            <div class="cname"><name>小丸子</name> <date>2021-12-29</date></div> 
            <div class="star">
              <img src="assets/star.png" class="starimg">
              <img src="assets/star.png" class="starimg">
              <img src="assets/star.png" class="starimg">
          ...
          <div class="comment">
            <div class="avatar11">
              ...
              <div class="cname"><name>阿晏</name> <date>2021-12-31</date></div> 
              <div class="star">
                <img src="assets/star.png" class="starimg">
                <img src="assets/star.png" class="starimg">
                <img src="assets/star.png" class="starimg">
            ...
            <div class="comment">
              <div class="avatar11">
                ...
                <div class="cname"><name>阿恆</name> <date>2022-01-05</date></div> 
                <div class="star">
                  <img src="assets/star.png" class="starimg">
                  <img src="assets/star.png" class="starimg">
                  <img src="assets/star.png" class="starimg">
