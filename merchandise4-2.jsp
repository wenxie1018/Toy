...
<head>
    ...
    <title>玩物喪薪|Medicom Toy UDF 蠟筆小新3 屁股走路 野原廣志 蠟筆小新</title>
...
<body id="body1">
    ...
    <section style="height: 900px;">
        ...
        <div class="slideshow-container">
            ...
            <div class="mySlides fade">
              <img src="assets/蠟筆小新/屁股走路/1.jpg" style="width:100%">
            </div>
            <div class="mySlides fade">
              <img src="assets/蠟筆小新/屁股走路/2.jpg" style="width:100%">
            </div>
          ...
          <div class="productname">
            <h1>Medicom Toy UDF 蠟筆小新3 屁股走路 野原廣志 蠟筆小新</h1><br>
            <p class="money">NT$599</p><br>
            <ul class="btn-numbox">
                ...
                <li><span class="kucun">（庫存:48）</span></li>
    　　　  </ul>
    ...
    <div class="com">
      ...
      <img src="assets/蠟筆小新/屁股走路/1.jpg" class="merimg"><p>
      <img src="assets/蠟筆小新/屁股走路/2.jpg" class="merimg"><p>
      <img src="assets/蠟筆小新/屁股走路/3.jpg" class="merimg"><p></p>
      <img src="assets/蠟筆小新/屁股走路/4.jpg" class="merimg" style="margin-bottom: 30px;">
      </div>
      <div class="link-top"></div>
      ...
      <div class="link-top"></div>
      <div style="text-align: left; font-size: 20px; color: rgb(104, 103, 103); margin-left: 10px;">60則評論</div>
      <div class="comment">
        <div class="avatar11">
          <img src="assets/astronaut.png" class="avatar">
        </div>
          <div class="cname"><name>小白</name> <date>2021-12-27</date></div> 
          <div class="star">
        ...
        <div class="comment">
          <div class="avatar11">
            ...
            <div class="cname"><name>小橘</name> <date>2021-12-29</date></div> 
            <div class="star">
              <img src="assets/star.png" class="starimg">
              <img src="assets/star.png" class="starimg">
              <img src="assets/star.png" class="starimg">
          ...
          <div class="comment">
            <div class="avatar11">
              ...
              <div class="cname"><name>阿花</name> <date>2021-12-31</date></div> 
              <div class="star">
                <img src="assets/star.png" class="starimg">
                <img src="assets/star.png" class="starimg">
                <img src="assets/star.png" class="starimg">
            ...
            <div class="comment">
              <div class="avatar11">
                ...
                <div class="cname"><name>阿晏</name> <date>2022-01-05</date></div> 
                <div class="star">
                  <img src="assets/star.png" class="starimg">
                  <img src="assets/star.png" class="starimg">
                  <img src="assets/star.png" class="starimg">
