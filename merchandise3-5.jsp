...
<head>
    ...
    <title>玩物喪薪|BANPRESTO 景品 QPOSKET 美少女戰士Eternal 愛野美奈子</title>
...
<body id="body1">
    <header id="navbar">
            ...
            <div class="dropdown">
              <a href="shoppingcart.html"><button class="dropbtn" style="color: black;">購物車</button></a>
    ...
    <section style="height: 900px;">
        ...
        <div class="slideshow-container">
            ...
            <div class="mySlides fade">
              <img src="assets/美少女戰士/3/7.jpg" style="width:100%">
            </div>
          ...
          <div class="productname">
            <h1>BANPRESTO 景品 QPOSKET 美少女戰士Eternal 愛野美奈子</h1><br>
            <p class="money">NT$499</p><br>
            <ul class="btn-numbox">
                ...
                <li><span class="kucun">（庫存:49）</span></li>
    　　　  </ul>
    ...
    <div class="com">
      ...
      <img src="assets/美少女戰士/3/2.jpg" class="merimg"><p>
      <img src="assets/美少女戰士/3/7.jpg" class="merimg" style="margin-bottom: 30px;">
      </div>
      <div class="link-top"></div>
      ...
      <div class="comment">
        <div class="avatar11">
          ...
          <div class="cname"><name>小王子</name> <date>2021-12-27</date></div> 
          <div class="star">
        ...
        <div class="comment">
          <div class="avatar11">
            ...
            <div class="cname"><name>羊咩</name> <date>2021-12-29</date></div> 
            <div class="star">
              <img src="assets/star.png" class="starimg">
              <img src="assets/star.png" class="starimg">
              <img src="assets/star.png" class="starimg">
          ...
          <div class="comment">
            <div class="avatar11">
              ...
              <div class="cname"><name>阿仔</name> <date>2021-12-31</date></div> 
              <div class="star">
                <img src="assets/star.png" class="starimg">
                <img src="assets/star.png" class="starimg">
                <img src="assets/star.png" class="starimg">
