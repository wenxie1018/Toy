...
<head>
    ...
    <title>玩物喪薪|LOOK UP 抬頭系列 Q版造型公仔 栗花落香奈乎</title>
...
<body id="body1">
    ...
    <section style="height: 900px;">
        ...
        <div class="slideshow-container">
            ...
            <div class="mySlides fade">
              <img src="assets/鬼滅抬頭/3/0 (3).png" style="width:100%">
            </div>

            <div class="mySlides fade">
              <img src="assets/鬼滅抬頭/3/1.png" style="width:100%">
            </div>
            
            <div class="mySlides fade">
              <img src="assets/鬼滅抬頭/3/2.png" style="width:100%">
            </div>
          ...
          <div class="productname">
            <h1>LOOK UP 抬頭系列 Q版造型公仔 栗花落香奈乎</h1><br>
            ...
            <ul class="btn-numbox">
                ...
                <li><span class="kucun">（庫存:52）</span></li>
    　　　  </ul>
    ...
    <div class="com">
      ...
      <img src="assets/鬼滅抬頭/3/0 (3).jpg" class="merimg"><P>
      <img src="assets/鬼滅抬頭/3/1.jpg" class="merimg"><P>
      <img src="assets/鬼滅抬頭/3/2.jpg" class="merimg"><P>
      <img src="assets/鬼滅抬頭/3/3.jpg" class="merimg"><P>
      <img src="assets/鬼滅抬頭/3/4.jpg" class="merimg"><P>
      <img src="assets/鬼滅抬頭/3/5.jpg" class="merimg"><P>
      <img src="assets/鬼滅抬頭/3/6.jpg" class="merimg"><P>
      <img src="assets/鬼滅抬頭/3/7.jpg" class="merimg" style="margin-bottom: 30px;">
      </div>
      <div class="link-top"></div>
      ...
      <div class="link-top"></div>
      <div style="text-align: left; font-size: 20px; color: rgb(104, 103, 103); margin-left: 10px;">48則評論</div>
      <div class="comment">
        <div class="avatar11">
          <img src="assets/astronaut.png" class="avatar">
        </div>
          <div class="cname"><name>小小兵</name> <date>2021-12-27</date></div> 
          <div class="star">
        ...
        <div class="comment">
          <div class="avatar11">
            ...
            <div class="cname"><name>內湖蔡依林</name> <date>2021-12-29</date></div> 
            <div class="star">
              <img src="assets/star.png" class="starimg">
              <img src="assets/star.png" class="starimg">
              <img src="assets/star.png" class="starimg">
          ...
          <div class="comment">
            <div class="avatar11">
              ...
              <div class="cname"><name>飯糰</name> <date>2021-12-31</date></div> 
              <div class="star">
                <img src="assets/star.png" class="starimg">
                <img src="assets/star.png" class="starimg">
                <img src="assets/star.png" class="starimg">
            ...
            <div class="comment">
              <div class="avatar11">
                ...
                <div class="cname"><name>企鵝</name> <date>2022-01-05</date></div> 
                <div class="star">
                  <img src="assets/star.png" class="starimg">
                  <img src="assets/star.png" class="starimg">
                  <img src="assets/star.png" class="starimg">
